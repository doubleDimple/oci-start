...
<script>
    window.I18N = {
        ...
        notification_dingTalkUpdateFail: "${msg.get('notification.dingTalkUpdateFail')?js_string}",
        notification_taskUpdateFail: "${msg.get('notification.taskUpdateFail')?js_string}"
    };
</script>
