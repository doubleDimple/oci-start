...
<script>
    window.I18N = {
        ...
        token_revokeFail: "${msg.get('token.revokeFail')?js_string}",
        token_days_suffix: "${msg.get('token.daysSuffix')?js_string}",
        common_confirm: "${msg.get('common.confirm')?js_string}",
        common_cancel: "${msg.get('common.cancel')?js_string}",
        common_copyFailManual: "${msg.get('common.copyFailManual')?js_string}",
